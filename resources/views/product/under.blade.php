                ...
                <div class="col-md-3">  
                     ...
                     {{csrf_field()}}
                          <div style="border:1px solid #333; height: 380px; background-color:#727276; border-radius:5px; padding:16px; margin-top:30px;" align="center">  
                               ...
                               <input type="hidden" name="hidden_name" value="{{$u->productName}}" />  
                               <input type="hidden" name="hidden_id" value="{{$u->productId}}" />  
                               <input type="hidden" name="hidden_price" value="{{$u->productPrice}}" />  
